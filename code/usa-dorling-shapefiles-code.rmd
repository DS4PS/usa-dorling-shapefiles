...
sea <- build_dorling_metro( cbsa.name = seattle )

phoenix <- "Phoenix-Mesa-Scottsdale, AZ"
phx <- build_dorling_metro( cbsa.name = phoenix )

lynchburg <- "Lynchburg, VA"
lburg <- build_dorling_metro( cbsa.name = lynchburg )


# "51009" "51011" "51019" "51031" "51515" "51680"
